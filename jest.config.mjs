...
function getJestAliases() {
  ...
  return {
    ...
    '^universe\\+cli$': '<rootDir>/packages/cli/src/index.ts',
    '^universe\\+debug$': '<rootDir>/packages/debug/src/index.ts',
    '^universe\\+github$': '<rootDir>/packages/github/src/index.ts',
    '^universe\\+listr2$': '<rootDir>/packages/listr2/src/index.ts',
