...
var Echo = function(...args)
{
    ...
    if(calledWithNew)
    {
        ...
        Object.defineProperty(this, 'prefix',
            { value : args[0] || null, writeable : true, enumerable : false, configurable: false });
    ...
    else
    {
        if(!this._instantiatedAlready)
            throw 'you must construct a new instance of the Echo object before attempting to call it as a function';
